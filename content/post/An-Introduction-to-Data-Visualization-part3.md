...
In the last two posts of this series the empasis was on the importance of using visualization for understanding data and sharing information. In this blog post I intend to highlight the basic process involved in using visualization to understand the data and communicate the finding to an audience.
...
Step 7: Explore the base visualizations and configure
...
Step 10: I like this one better, so let's proceed to the next step with 'Life Expectancy' along the x axis. Lets customize little more and add more dimensions/attributes to the plot. We have 'Population' and 'Region' data available. How can we encode them?
...
Step 11: More customizations. Now let us given each region a color to add more dimesnions and provide a legend
```python
from bokeh.io import show
from bokeh.models import LinearInterpolator
from bokeh.plotting import figure
